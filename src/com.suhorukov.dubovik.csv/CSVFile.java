...
class CSVFile {
    ...
    CSVFile(String inFileName, String outFileName) throws IOException {
    ...
    private void writeFileWords(List<Map.Entry<String, Integer>> list, int numbersOfLines, PrintWriter writer) {
        ...
        writer.printf("%s" + SYMBOL_CSV + "%s" + SYMBOL_CSV + "%s%n", "Слово", "Частота", "Частота%");
        ...
        writer.printf("%n%s" + SYMBOL_CSV + "%,d", "Общее количество строк:", numbersOfLines);
    }
